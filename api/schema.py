...
class Query(ObjectType):
    ...
    book_by_author = Field(
        AuthorType, first_name=String(required=True), last_name=String(required=True)
    )
            ...
            if "author" in book_data:
                ...
                if new or book_instance.author != author_instance:
                    ...
                    if "first_name" in author:
                        author_instance.first_name = author.first_name
                    if "last_name" in author:
                        author_instance.last_name = author.last_name
                    if "dob" in author:
                        author_instance.dob = author.dob
